...
msg.Text = "Ella Hub is down forever xx go use dramaware or Jann since u think thats better"
...
discordBtn.Text = "Get Ella Hub Back!"
...
discordBtn.MouseButton1Click:Connect(function()
    pcall(function() setclipboard("go use dramaware bitch fuck u") end)
    discordBtn.Text = "no ur not getting it back xx!"
